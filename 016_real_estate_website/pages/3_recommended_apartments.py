...
location_df = pickle.load(open(DATASET_DIR / 'location_distance.pkl','rb'))

cosine_sim1 = pickle.load(open(DATASET_DIR / 'cosine_sim1.pkl','rb'))
cosine_sim2 = pickle.load(open(DATASET_DIR / 'cosine_sim2.pkl','rb'))
cosine_sim3 = pickle.load(open(DATASET_DIR / 'cosine_sim3.pkl','rb'))
...
st.title('Location Radius Search')
